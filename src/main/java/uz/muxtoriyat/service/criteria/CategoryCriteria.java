...
/**
 * Criteria class for the {@link uz.muxtoriyat.domain.Category} entity. This class is used
 * in {@link uz.muxtoriyat.web.rest.CategoryResource} to receive all the possible filtering options from
...
public class CategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, order, parentId, distinct);
    }
