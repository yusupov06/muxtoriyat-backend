...
import uz.muxtoriyat.security.AuthoritiesConstants;
import uz.muxtoriyat.service.MailService;
...
import uz.muxtoriyat.web.rest.errors.EmailAlreadyUsedException;
import uz.muxtoriyat.web.rest.errors.LoginAlreadyUsedException;

/**
 * REST controller for managing users.
 * <p>
 * This class accesses the {@link uz.muxtoriyat.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody AdminUserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            mailService.sendLoginPasswordViaEmail(newUser, generatePassword);
