...
import { sampleWithRequiredData } from '../source.test-samples';
...
describe('Source Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to sourceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSourceIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSourceIdentifier).toHaveBeenCalledWith(entity);
