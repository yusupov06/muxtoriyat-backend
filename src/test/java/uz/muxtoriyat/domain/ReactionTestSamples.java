...
public class ReactionTestSamples {
    ...
    public static Reaction getReactionSample1() {
        return new Reaction().id(1L).deviceId("deviceId1");
    }

    public static Reaction getReactionSample2() {
        return new Reaction().id(2L).deviceId("deviceId2");
    }

    public static Reaction getReactionRandomSampleGenerator() {
        return new Reaction().id(longCount.incrementAndGet()).deviceId(UUID.randomUUID().toString());
    }
}
